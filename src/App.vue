...
export default {
  ...
  created() {
    ...
    // 挂载全局脚本
    window.Vue = Vue;
    axios.get('/BI/Component/GetGlobalModuleScript', { timeout: 1000 * 6, }).then(({ data }) => {
      if (data.state !== 200) {
      ...
      data.data.forEach(item => {
        ...
        CompileToModule(item.code).then(module => {
          if (Object.prototype.toString.call(module.default) === '[object Function]') {
