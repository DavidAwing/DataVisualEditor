...
<template>
  <div @click="onEvent('onClick', { $event })" @mouseover="onEvent('onMouseover', { $event })"
    @mouseout="onEvent('onMouseout', { $event })" style="visibility: visible" ref="el">
