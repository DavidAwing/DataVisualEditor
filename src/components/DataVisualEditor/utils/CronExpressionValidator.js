...
export default function CronExpressionValidator() {
}
...
CronExpressionValidator.validateCronExpression = function (value) {
  ...
  const expressionArray = value.split(" ");
...
CronExpressionValidator.segmentValidator = function (expression, value, range, segmentName) {
  ...
  while (++i < l) {
    ...
    if (match && match[0] == checkSegment && checkSegment.indexOf("L") == -1 &&
      checkSegment.indexOf("l") == -1 && checkSegment.indexOf("C") == -1 &&
      checkSegment.indexOf("c") == -1 && checkSegment.indexOf("W") == -1 &&
      checkSegment.indexOf("w") == -1 && checkSegment.indexOf("/") == -1 &&
