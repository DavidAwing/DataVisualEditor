  ...
  <div>
          ...
          <div class="datav-marquee">
            <span class="content">
              <template v-for="n in 2">
                <div :key="n">
                  1. DataV 仅支持谷歌 Chrome 浏览器版本 62 以上。2. DataV 基于
                  Vue 3.x 开发。3. 项目地址：<a
                    href="https://github.com/pengxiaotian/datav-vue"
                    target="_blank"
                    class="project-href"
                    >https://github.com/pengxiaotian/datav-vue</a
                  >
    ...
    <div class="datav-nav">
      <div class="header-img">
        <img class="nav-img-text" :src="`/datav/nav-img-text.png`" />
...
import { h, ref, reactive, defineComponent, computed } from "vue-demi";
