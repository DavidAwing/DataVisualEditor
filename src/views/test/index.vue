<template>
  <div class="container" id="test222">
    ...
    <div id="imgtest" style="width: 100%;background-color: blue;height: 900px;color: white;">
...
import {
  addStyleToHead, removeStyleById, deleteSelectorForStyle, addSelectorToStyle, getCssStr, getCssStr2, getStyleSelectorStr, cssTab,
  compressCssStrWhitespace, parseCssExpressions
